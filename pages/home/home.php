                ...
                <div class="row">
                    <div class="col-6">
                        <div class="card card-success card-outline">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"> Add your Input here!</h5>
                            </div>
                    ...
                    <div class="col-6">
                        <div class="card card-danger card-outline">
                            ...
                            <div class="card-body">
                                <h5 class="card-title"> Add datatable here!</h5>
                                <br />
                                <br />
                                <p>Your datatable should consist basic info and such as full name , grade , section and "option" column for edit/delete student</p>
                            </div>
                        </div>
                    </div>
